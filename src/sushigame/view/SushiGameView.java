...
public class SushiGameView extends JPanel implements ActionListener, BeltObserver {
	...
	private BeltViewWidget beltview;
	...
	public SushiGameView(SushiGameModel game_model) {
		...
		//bottom_panel.setSize(500,500);
		
		JButton rotate_button = new JButton("Rotate");
		rotate_button.setPreferredSize(new Dimension(200, 100));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("ingredients")) {
			final JFrame frame = new JFrame();
	        JPanel panel = new JPanel();
	        frame.add(panel);
	        frame.setVisible(true);
			JOptionPane.showMessageDialog(frame.getComponent(0), beltview.getRollIngredients());
		}
	}
	...
	public void handleBeltEvent(BeltEvent e) {
		...
		if (e.getType() == BeltEvent.EventType.PLATE_PLACED) {
			controller_messages.setText("plate placed");
		}
	}
